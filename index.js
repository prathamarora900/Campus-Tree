...
const aChatSchema = require("./models/allChats");
const OnlySchema = require("./models/OnlyIds");
...
console.log("this is name "+server_cookies_user_name);
console.log("this is id "+server_cookies_user_id);
